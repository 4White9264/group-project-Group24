...
def get_article_details(title):
    ...
    # 从 Section_D_output 获取 AI 评价, 每个key一行
    ...
    article = {
        ...
        'first_author_info_latest_three': Section_D_output.get('First Author Info', {}).get('latest_three_publications', []),
...
for i in article.get('first_author_info_latest_three', 'N/A'):
    print(i)